...
class SurfaceRivetNode(ompx.MPxNode):
    ...
    def compute(self,plug,data):
        ...
        if plug == SurfaceRivetNode.outTranslation or plug == SurfaceRivetNode.outRotation or plug == SurfaceRivetNode.outNormalVector or plug == SurfaceRivetNode.outTangentVector:
